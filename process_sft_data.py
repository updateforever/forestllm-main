...
def extract_cot_answer(item, mastery_level):
    ...
    if cot == "":
        # 调用
        response = virtual_teacher.cot_deepseek(response=question)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_mc", type=str, default="/home/wyp/project/ForestLLM/data_sft/article/train_multiple_choice.jsonl")
    parser.add_argument("--train_qa", type=str, default="/home/wyp/project/ForestLLM/data_sft/article/train_general_qa.jsonl")
    parser.add_argument("--eval_mc", type=str, default="/home/wyp/project/ForestLLM/data_sft/article/eval_multiple_choice.csv")
    parser.add_argument("--eval_qa", type=str, default="/home/wyp/project/ForestLLM/data_sft/article/eval_general_qa.jsonl")
